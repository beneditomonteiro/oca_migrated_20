...
# NOTE ON THIS ODOO 20 VERSION:
# This is just a simple porting of OCA/web's `web_responsive` (19.0 branch,
# repository commit d3748a6ea5, 2026-09-18) to Odoo 20, published meanwhile
# the official OCA 20.0 version is not released yet. It is an offer from the
# Maxdoo Team, represented by Benedito Monteiro. All original authors,
# copyrights and the LGPL-3 license above are preserved; once the official
# OCA version for Odoo 20 is available, prefer it over this one.
